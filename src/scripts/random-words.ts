...
const FALLBACK_WORDS: readonly string[] = [
	'apple', 'autumn', 'banana', 'beach', 'beautiful', 'book', 'bread', 'butter',
	'cat', 'chair', 'cheese', 'cloud', 'coffee', 'cold', 'computer', 'dance',
	'day', 'desert', 'doctor', 'dog', 'door', 'draw', 'dream', 'earth',
	'elephant', 'evening', 'family', 'fast', 'fire', 'fish', 'flower', 'forest',
	'garden', 'happy', 'horse', 'hot', 'house', 'ice', 'jungle', 'kite',
	'laugh', 'light', 'lion', 'love', 'milk', 'moon', 'morning', 'mountain',
	'music', 'night', 'ocean', 'orange', 'paint', 'peace', 'phone', 'piano',
	'queen', 'rain', 'read', 'river', 'run', 'sand', 'school', 'sing',
	'sky', 'sleep', 'slow', 'small', 'smile', 'snow', 'spring', 'star',
	'stone', 'street', 'student', 'sugar', 'summer', 'sun', 'table', 'teacher',
	'tea', 'tree', 'umbrella', 'valley', 'walk', 'water', 'window', 'winter',
	'world', 'write', 'year', 'yellow'
];
